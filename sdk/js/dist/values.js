...
export function isApiValue(value) {
...
export function toApiValue(value) {
    ...
    if (isPlainObject(value)) {
        return {
            Record: Object.fromEntries(Object.entries(value).map(([key, nested]) => [key, toApiValue(nested)])),
        };
    }
    throw new Error(`Cannot convert value to ApiValue: ${typeof value}`);
}
export function fromApiValue(value) {
    if ("Null" in value) {
        return null;
    }
    if ("Bool" in value) {
    ...
    if ("Record" in value) {
        return Object.fromEntries(Object.entries(value.Record).map(([key, nested]) => [key, fromApiValue(nested)]));
    }
    return value;
}
...
export function makeQueryRequest(query, params) {
    return {
        query,
        params: toApiParams(params),
    };
}
export function makePrepareRequest(name, query, options) {
    const request = {
        name,
        query,
    };
...
export function makeExecutePreparedRequest(name, params, sort) {
    const request = {
        name,
        params: toApiParams(params),
    };
