...
use gleaph_graph_kernel::vector_index::{VectorEncoding, decode_f16_to_f32, decode_i8_to_f32};
...
/// sign-equivalent dequantization the search-side kernels fuse; `F16` upcasts.
