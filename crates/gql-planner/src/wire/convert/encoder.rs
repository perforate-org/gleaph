...
use crate::plan::{
    ...
    ShortestPathCost, WcojEdge,
};

use super::helpers::{
    encode_conditional_candidate, encode_edge_inline_property_predicate,
    ...
    fn encode_op(&mut self, op: &PlanOp) -> Result<PlanOpWire, String> {
        Ok(match op {
            ...
            PlanOp::Expand {
                ...
                edge_inline_property_predicate: encode_edge_inline_property_predicate(
                    edge_inline_property_predicate,
                )?,
            ...
            PlanOp::InlineProcedureCall {
                ...
                scope: encode_inline_procedure_scope(scope),
                optional: *optional,
            },
            PlanOp::UseGraph {
                graph_name,
...
fn encode_inline_procedure_scope(scope: &InlineProcedureScope) -> InlineProcedureScopeWire {
    match scope {
        InlineProcedureScope::ImplicitAll => InlineProcedureScopeWire::ImplicitAll,
        InlineProcedureScope::Explicit(vars) => InlineProcedureScopeWire::Explicit(vec_str(vars)),
    }
}
