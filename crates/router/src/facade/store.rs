...
use super::stable::{
    ...
    ROUTER_MUTATION_COUNTER, ROUTER_PROPERTY_CATALOG, ROUTER_SHARD_BY_GRAPH, ROUTER_SHARDS,
    ROUTER_SHARDS_BY_GRAPH_ID, ROUTER_UNIQUE_CONSTRAINTS, ROUTER_VERTEX_LABEL_CATALOG,
