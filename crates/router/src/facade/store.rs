...
use super::stable::{
    ...
    ROUTER_EDGE_LABEL_STATS, ROUTER_GRAPH_CATALOG, ROUTER_GRAPHS, ROUTER_INDEX_NAME_CATALOG,
    ROUTER_MUTATION_BY_CLIENT_KEY, ROUTER_MUTATION_COUNTER, ROUTER_PLACEMENTS,
