//! [`GraphRead`] for [`GraphStoreKernelOverlayGraph`].
//!
...
use super::GraphStoreKernelOverlayGraph;
use super::overlay_types::ExpansionWithShard;

impl<'a, S: super::GraphStoreStore> GraphRead for GraphStoreKernelOverlayGraph<'a, S> {
