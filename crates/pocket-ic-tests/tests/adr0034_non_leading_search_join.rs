...
use gleaph_pocket_ic_tests::{
    ...
    ensure_edge_label, ensure_vertex_label, gql_query_with_params_as_admin, install_federation,
...
fn seed_embedding(
    ...
    let _: () = Decode!(&bytes, Result<(), gleaph_graph_kernel::vector_index::VectorCanisterError>)
