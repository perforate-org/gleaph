...
- `bench_bitset_reopen_after_pure_journal_4096`
- `bench_bitset_reopen_after_segmented_journal_4096`
- `bench_bitset_reopen_after_remove_heavy_journal_4096`
...
- `bench_bitset_reopen_after_pure_journal_4096`
  - long `set`/`clear` runs with no `remove` boundaries
- `bench_bitset_reopen_after_segmented_journal_4096`
  - `set`/`clear` runs split by a `remove` block that forces a flush boundary
- `bench_bitset_reopen_after_remove_heavy_journal_4096`
  - a remove-rich journal that should benefit less from replay batching
