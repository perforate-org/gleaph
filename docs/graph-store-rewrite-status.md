# graph-store Rewrite Status

Last updated: 2026-03-30

## Purpose

This document records the current implementation state of the `graph-store`
...
- [`graph-store-property-store-spec.md`](graph-store-property-store-spec.md)
- adjacency next-step handoff:
  - [`graph-store-adjacency-next-roadmap.md`](graph-store-adjacency-next-roadmap.md)
...
[`crates/graph-store/src/property_index/`](../crates/graph-store/src/property_index/)
(primarily [`node_store.rs`](../crates/graph-store/src/property_index/node_store.rs)
and [`mod.rs`](../crates/graph-store/src/property_index/mod.rs)).
