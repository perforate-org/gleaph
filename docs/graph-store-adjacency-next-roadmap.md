# graph-store Adjacency Next Roadmap
...
- [`graph-store-low-level-spec.md`](./graph-store-low-level-spec.md)
- [`graph-store-target-design.md`](./graph-store-target-design.md)
...
- [`crates/graph-store/src/low_level/ids.rs`](../crates/graph-store/src/low_level/ids.rs)
- [`crates/graph-store/src/low_level/edge.rs`](../crates/graph-store/src/low_level/edge.rs)
- [`crates/graph-store/src/low_level/vertex.rs`](../crates/graph-store/src/low_level/vertex.rs)
...
- [`crates/graph-store/src/low_level/locator.rs`](../crates/graph-store/src/low_level/locator.rs)
- [`crates/graph-store/src/low_level/graph.rs`](../crates/graph-store/src/low_level/graph.rs)
...
- [`crates/graph-store/src/low_level/graph.rs`](../crates/graph-store/src/low_level/graph.rs)
- [`crates/graph-store/src/low_level/manager.rs`](../crates/graph-store/src/low_level/manager.rs)
- [`crates/graph-store/src/facade.rs`](../crates/graph-store/src/facade.rs)
...
- [`crates/graph-store/src/low_level/runtime.rs`](../crates/graph-store/src/low_level/runtime.rs)
...
- [`crates/graph-store/src/low_level/hydration.rs`](../crates/graph-store/src/low_level/hydration.rs)
- [`crates/graph-store/src/low_level/manager.rs`](../crates/graph-store/src/low_level/manager.rs)
...
- **No subscript access:** the `gleaph-graph-store` crate has **no** `base_entries[…]` uses; tests and
...
- **Segment-zero slot sync call sites:** `sync_segment_zero_slot_capacity_from_storage_len` and its three call
  ...
  [`runtime.rs`](../crates/graph-store/src/low_level/runtime.rs), including that **manager/header sync**
  is authoritative when present and that **shrinking** these calls needs an explicit invariant pass
  (no ad hoc removal).
- **Doc + iteration API:** [`SurfaceBaseStorage`](../crates/graph-store/src/low_level/runtime.rs) has
  ...
  a public [`SurfaceBaseStorage::iter`](../crates/graph-store/src/low_level/runtime.rs) over flattened
...
- **Observability:** maintenance-cycle uses a `window_total_base_slots` label matching the projection
  ...
  ambiguous `storage=`) ([`observability.rs`](../crates/graph-store/src/observability.rs)).
...
- **Maintenance narrative:** `GraphRuntime::apply_local_rebalance_delta_with_segment_replacement`
  documents the **canonical** path; [`SurfaceBaseStorage`](../crates/graph-store/src/low_level/runtime.rs)
...
- **Tests:** `base_entries` assignments in [`facade.rs`](../crates/graph-store/src/facade.rs),
  [`integration.rs`](../crates/graph-store/src/integration.rs), and
  [`runtime.rs`](../crates/graph-store/src/low_level/runtime.rs) tests now use
  **`SurfaceBaseStorage::from_contiguous(vec![…])`** for explicit storage intent; `SurfaceBaseStorage` is
  **re-exported** from [`low_level/mod.rs`](../crates/graph-store/src/low_level/mod.rs) for same-crate use.

### Facade in-memory shape (policy)

The low-level graph can still start life with **contiguous** backing in some construction paths.
**Policy:** `GraphStore` does **not** auto-call `migrate_contiguous_base_to_segment_zero`
...
- **Done:** struct-level documentation on `SurfaceBaseStorage` in
  [`runtime.rs`](../crates/graph-store/src/low_level/runtime.rs) linking to
...
- **Progress:** [`SurfaceBaseStorage::iter`](../crates/graph-store/src/low_level/runtime.rs) used in
...
- [`crates/graph-store/src/facade.rs`](../crates/graph-store/src/facade.rs)
- [`crates/graph-store/src/low_level/runtime.rs`](../crates/graph-store/src/low_level/runtime.rs)
- [`crates/graph-store/src/observability.rs`](../crates/graph-store/src/observability.rs)
