...
| **Split ownership risk** | Without a router SSOT, future per-shard schema would diverge (same class of problem as pre-[0008](0008-edge-inline-property-profile-router-ssot.md) edge inline property profiles) |
