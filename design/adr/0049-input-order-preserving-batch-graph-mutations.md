...
18. **Partially implemented (2026-07-29 02:37:18 UTC +0000):** GraphStore now
    ...
    catalog filter and remove-then-insert transition order. Complete-set preflight and the
