...
`STRUCT` inline slots, mutation packing of ordinary scalar values into the inline payload, `COST BY e.property`, and generic `CREATE GRAPH TYPE` `INLINE` annotations remain planned.
