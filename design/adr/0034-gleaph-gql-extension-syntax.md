...
11. Add exactly one equality predicate and one one-sided numeric range predicate on distinct properties of the searched vertex for leading and non-leading `SEARCH ... WHERE` (ADR 0034 Slice 11, done).
12. Add exactly one equality predicate and two same-property numeric range predicates (one lower and one upper) on a distinct property of the searched vertex for leading and non-leading `SEARCH ... WHERE` (ADR 0034 Slice 12, done).
