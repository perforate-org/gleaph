...
| Date       | Change                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-16 | ADR 0043 proposed per-`MemoryId` bucket sizing behind the existing region-ownership policy; the current 16-page Graph setting remains an interim implementation until the custom manager is validated. |
