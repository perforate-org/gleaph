...
| Date       | Change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-22 | Router MemoryId 53 remains the sole direct-ingestion lifecycle owner and now stores `AwaitingGraph \| AwaitingVector \| AwaitingFrontier`. Graph rejection and observed Vector-prefix resolution retain exact rows as frontier markers; Router derives marked target/shard frontiers from the oldest unresolved exact-lane intent or the durable allocation ceiling, and retires only the unchanged marker snapshot after an observed Vector acknowledgement. The Router-only Vector endpoint applies the frontier monotonically to MemoryId 15 and runs one bounded GC step in the same no-await update. The focused frontier PocketIC and benchmark gates pass; unfiltered persisted canbench artifacts and the final plan gate remain pending. No new stable region is allocated. |
