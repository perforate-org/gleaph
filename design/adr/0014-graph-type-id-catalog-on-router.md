...
| 2026-06-13 | Accepted: T0–T4 — `GraphTypeId`, regions 32–33, `GraphTypeLookup`, V2 bindings, PocketIC regression. |
...
| Phase | Scope | Status |
|-------|--------|--------|
| **T0** | `GraphTypeId` in `graph-kernel`; `CatalogId`; layout registry regions 32–33 | **Implemented** |
...
| [storage/stable-memory-inventory.md](../storage/stable-memory-inventory.md) | Regions 32–33; router count 34 | **Implemented** |
