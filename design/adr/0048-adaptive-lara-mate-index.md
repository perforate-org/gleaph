...
The Graph bench adapter now consumes those physical rows for both directed sizes plus undirected
and undirected-self-loop AliasOnly fixtures; parallel, sparse-slot, and mixed-label shapes remain
deferred.
