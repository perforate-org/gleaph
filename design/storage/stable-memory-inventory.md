...
| Provision | 11 | 0–10 | `PROVISION_STABLE_LAYOUT` — `provision_layout_registry_matches_baseline` |
...
Graph facade **46 regions** total (32 LARA + 14 facade). Retired 2026-06-12: `EDGE_PAYLOAD_PROFILES` → router SSOT ([ADR 0008](../adr/0008-edge-inline-value-profile-router-ssot.md)); `EDGE_EQUALITY_POSTINGS` → graph-index ([ADR 0009](../adr/0009-edge-property-index-and-index-ddl.md)).
