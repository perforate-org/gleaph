...
- [adr/0048-adaptive-lara-mate-index.md](../adr/0048-adaptive-lara-mate-index.md) — accepted physical-pairing design; Plan 0132 adds one-pass live-slot traversal and exact scalar location consumption for supported named buckets, while persistent Sampled/Packed storage and EDGE_ALIASES removal remain planned
