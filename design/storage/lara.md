...
- [adr/0048-adaptive-lara-mate-index.md](../adr/0048-adaptive-lara-mate-index.md) — accepted physical-pairing design; Plan 0132 adds one-pass live-slot traversal and exact scalar location consumption for supported named buckets. Alias removal is primarily a persistent-bytes optimization; ScanOnly instruction cost is a guardrail, while Sampled/Packed promotion is expected to recover lookup cost before removal
