...
- [0016-overflow-log-tombstones-and-src-fields.md](../adr/0016-overflow-log-tombstones-and-src-fields.md) — log tombstone policy (phase 1 implemented); payload log 16 B compression deferred
