...
- [0016-overflow-log-tombstones-and-src-fields.md](../adr/0016-overflow-log-tombstones-and-src-fields.md) — log tombstone policy (phase 1); payload log `LVL` layout version 1, 16 B + bucket-derived inline/blob (phase 2)
