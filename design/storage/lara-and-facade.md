...
`mate`-named paths remain active for local-index movement, reverse repair, ordinary alias-row
counterpart removal, and other pending callers. The scan-only canonical-edge-handle helper, edge-property
