...
| [storage/bulk-ingest-finalize.md](storage/bulk-ingest-finalize.md) | partial (P0–P2) | GraphStore + canister wire + GQL `CALL GLEAPH.FINALIZE_*`; router orchestration deferred |
