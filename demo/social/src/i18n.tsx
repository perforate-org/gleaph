...
const enDictionary = {
  ...
  "feed.loading": "Loading scenario through Router…",
  ...
  "feed.routerNotConfigured":
    "Social demo Router canister id is not configured. Set VITE_GLEAPH_ROUTER_CANISTER_ID (and VITE_IC_HOST / VITE_FETCH_ROOT_KEY for local development).",
...
const jaDictionary: Record<TranslationKey, string> = {
  ...
  "feed.loading": "Router からシナリオを読み込んでいます…",
  "feed.empty": "このシナリオでは投稿が返されませんでした。",
  "feed.replyingTo": "{{author}}への返信",
  "feed.unknownAuthor": "元の投稿者",
  "feed.errorTitle": "シナリオに失敗しました",
  "feed.routerNotConfigured":
    "ソーシャルデモの Router canister ID が設定されていません。ローカル開発では VITE_GLEAPH_ROUTER_CANISTER_ID（必要に応じて VITE_IC_HOST / VITE_FETCH_ROOT_KEY）を設定してください。",
  ...
  "feed.seedLabelsNote":
    "ラベルは固定されたソーシャルグラフのシードを表します。シード対象を変更した場合は更新してください。",
...
const japaneseAnnotationCopy: Record<string, { label: string; description: string }> = {
  ...
  "Reply relationship": {
    label: "返信関係",
    description:
      "現在の投稿が返信であれば親投稿を検索します。返信がなければ親の値は null になります。",
  },
  Projection: {
    label: "射影",
  ...
  "Vector search": {
    label: "ベクトル検索",
    description:
      "クエリベクトルを使って post_vec ベクトルインデックスを検索し、近い投稿を返します。",
  },
  "Distance column": {
    label: "距離列",
  ...
  "Social graph pattern": {
    label: "ソーシャルグラフパターン",
    description:
      "ユーザーから FOLLOWS、POSTED をたどって投稿を検索し、意味検索の対象を制約します。",
  },
